...
export default function Signup() {
  const form = useForm({
    ...
    validate: {
      ...
      firstName: (value) =>
        value.length > 0 ? null : "First name cant be empty",
      secondName: (value) =>
        value.length > 0 ? null : "Second name cant be empty",
    },
  });
  return (
    <main className='w-1/2 relative  left-1/4  mt-auto mb-auto'>
      <div className='bg-white w-full min-h-[50vh] p-8 flex justify-center shadow-xl rounded-xl'>
        <div className='w-full'>
          ...
          >
            ...
            <Button
              type='submit'
              className='bg-blue-500 w-32 rounded-lg'
              size='md'
            >
              Sign Up
            </Button>
